...
export default function ChangePassword() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setErr('');
    if (!current || !newPw || !confirm) { setErr('Fill all fields'); return; }
  ...
  return (
    <div>
      <div className="pg-hd"><h2>Change Password</h2><p>Update your account password</p></div>
      <div className="pw-box">
        <form onSubmit={handleSubmit}>
          ...
          <div className="field"><label>Confirm New Password</label><input type="password" value={confirm} onChange={e => setConfirm(e.target.value)} /></div>
